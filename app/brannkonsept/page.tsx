            ...
            <div className="lg:w-[65%]">
              ...
              <ScrollReveal>
                ...
                <div className="bg-brand-lightgray rounded-[20px] p-6 mb-8">
                  <h3 className="font-bold text-brand-black mb-3">Vanlige risikoklasser i Agder:</h3>
                  <ul className="space-y-2 text-brand-darkgray text-sm">
                    <li><strong>RKL 1:</strong> Garasje, lager og andre bygg uten personopphold</li>
                    <li><strong>RKL 2:</strong> Enebolig, rekkehus og leiligheter — beboer kan selv rømme</li>
                    <li><strong>RKL 4:</strong> Kontorbygg, butikk, undervisningsbygg og forsamlingslokaler</li>
                    <li><strong>RKL 5:</strong> Hotell, overnatting og sykehjem — beboer sover på stedet</li>
                    <li><strong>RKL 6:</strong> Sykehus og institusjoner med svekkede beboere</li>
                  </ul>
                </div>
              </ScrollReveal>
