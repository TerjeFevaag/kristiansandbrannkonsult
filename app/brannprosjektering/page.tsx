...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Ja, de fleste tilbygg, bruksendringer og nye boenheter krever brannprosjektering. Ta kontakt for en gratis vurdering av akkurat ditt prosjekt â€” uansett hvor i Norge det befinner seg.',
  },
  {
    question: 'Er befaring nÃ¸dvendig?',
    answer:
      'For nybygg og enklere saker er det sjelden nÃ¸dvendig. Takket vÃ¦re digitale kartdata kan vi i mange tilfeller jobbe uten fysisk befaring â€” noe som gjÃ¸r det like enkelt Ã¥ betjene kunder i hele landet. Vi gir beskjed dersom vi ser behov for befaring.',
  },
  {
        ...
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-[65%]">
              ...
              <ScrollReveal>
                <p className="text-brand-darkgray leading-relaxed mb-8">
                  Vi hjelper kunder med brannprosjektering i Kristiansand og hele Agder â€” Lillesand, Grimstad, Mandal, Arendal og resten av landet. Kontakt oss for et uforpliktende tilbud.
                </p>
              </ScrollReveal>
